...
//     after having been `closed`/`connecting`. The server-side TmuxClient
//     at that point is a fresh process with no live subscriptions; live
//     entries are re-issued under their existing names so consumer-held
//     handles keep routing.
//
